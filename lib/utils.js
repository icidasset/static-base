...
function parse_toml_file(file_path) {
  if (typeof file_path !== "string") throw new TypeError("Value of argument 'file_path' violates contract, expected string got " + (file_path === null ? "null" : file_path instanceof Object && file_path.constructor ? file_path.constructor.name : typeof file_path));
...
function parse_toml(contents) {
  if (typeof contents !== "string") throw new TypeError("Value of argument 'contents' violates contract, expected string got " + (contents === null ? "null" : contents instanceof Object && contents.constructor ? contents.constructor.name : typeof contents));

  return _toml2["default"].parse(contents);
}
...
function parse_markdown_file(parser, file_path) {
  var front_matter_use_toml = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
  if (typeof file_path !== "string") throw new TypeError("Value of argument 'file_path' violates contract, expected string got " + (file_path === null ? "null" : file_path instanceof Object && file_path.constructor ? file_path.constructor.name : typeof file_path));
...
function parse_markdown(parser, contents) {
  var front_matter_use_toml = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
  if (typeof contents !== "string") throw new TypeError("Value of argument 'contents' violates contract, expected string got " + (contents === null ? "null" : contents instanceof Object && contents.constructor ? contents.constructor.name : typeof contents));
  ...
  front_matter = (0, _grayMatter2["default"])(contents, { parser: front_matter_parser });
...
function extract_title_from_markdown(markdown_text) {
  if (typeof markdown_text !== "string") throw new TypeError("Value of argument 'markdown_text' violates contract, expected string got " + (markdown_text === null ? "null" : markdown_text instanceof Object && markdown_text.constructor ? markdown_text.constructor.name : typeof markdown_text));
...
function path_to_key(file_path, base_path) {
  if (typeof file_path !== "string") throw new TypeError("Value of argument 'file_path' violates contract, expected string got " + (file_path === null ? "null" : file_path instanceof Object && file_path.constructor ? file_path.constructor.name : typeof file_path));
  if (typeof base_path !== "string") throw new TypeError("Value of argument 'base_path' violates contract, expected string got " + (base_path === null ? "null" : base_path instanceof Object && base_path.constructor ? base_path.constructor.name : typeof base_path));
...
function key_to_route(key) {
  if (typeof key !== "string") throw new TypeError("Value of argument 'key' violates contract, expected string got " + (key === null ? "null" : key instanceof Object && key.constructor ? key.constructor.name : typeof key));
...
function route_to_path(route) {
  if (typeof route !== "string") throw new TypeError("Value of argument 'route' violates contract, expected string got " + (route === null ? "null" : route instanceof Object && route.constructor ? route.constructor.name : typeof route));
...
function file_exists(path) {
  var warning = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
  if (typeof path !== "string") throw new TypeError("Value of argument 'path' violates contract, expected string got " + (path === null ? "null" : path instanceof Object && path.constructor ? path.constructor.name : typeof path));
  ...
  try {
    ...
    if (warning) console.log(_colors2["default"].yellow("WARNING: '" + path + "' was not found"));
    return false;
  }
}