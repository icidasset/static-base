...
function handle_file(page_path) {
  if (typeof page_path !== "string") throw new TypeError("Value of argument 'page_path' violates contract, expected string got " + (page_path === null ? "null" : page_path instanceof Object && page_path.constructor ? page_path.constructor.name : typeof page_path));
