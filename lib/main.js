...
var _buildJson = require("./build/json");
...
var _default = (function () {
  function _default(base_path, options) {
  ...
  _createClass(_default, [{
    ...
    value: function build() {
      var partial = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
      ...
      switch (partial) {
        ...
        case "html":
          promises.push((0, _buildHtml.build)(this, options));
          break;

        case "css":
        case "stylesheets":
          promises.push((0, _buildStylesheets.build)(this, options));
          break;

        case "js":
        case "javascripts":
          promises.push((0, _buildJavascripts.build)(this, options));
          break;

        case "static_assets":
          promises.push((0, _buildStatic_assets.build)(this, options));
          break;

        case "json":
          promises.push((0, _buildJson.build)(this, options));
          break;
    ...
    value: function clean() {
      ...
      if (this.is_ready) {
        (0, _cliClean2["default"])(this, options);
      }
    }
  }, {
    key: "watch",
    value: function watch() {
      var options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
      if (this.is_ready) {
        (0, _cliWatch2["default"])(this, options);
      }
    }
