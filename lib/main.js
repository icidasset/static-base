  ...
  _createClass(_class, [{
    ...
    value: function build() {
      ...
      switch (partial) {
        ...
        case "html":
          promises.push((0, _buildHtml.build)(this, minify));
          break;

        case "css":
        case "stylesheets":
          promises.push((0, _buildStylesheets.build)(this, minify));
          break;

        case "js":
        case "javascripts":
          promises.push((0, _buildJavascripts.build)(this, minify));
          break;
        ...
        case "json":
          promises.push((0, _buildJson.build)(this));
          break;
