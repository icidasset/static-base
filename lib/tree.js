...
var Tree = (function () {
  ...
  _createClass(Tree, [{
    ...
    value: function store(key, value) {
      var extend = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
...
var PagesTree = (function (_Tree) {
  ...
  _createClass(PagesTree, [{
    ...
    value: function handle_collection_item(collection, page_key, page_route, item) {
      if (typeof page_key !== "string") throw new TypeError("Value of argument 'page_key' violates contract, expected string got " + (page_key === null ? "null" : page_key instanceof Object && page_key.constructor ? page_key.constructor.name : typeof page_key));
      if (typeof page_route !== "string") throw new TypeError("Value of argument 'page_route' violates contract, expected string got " + (page_route === null ? "null" : page_route instanceof Object && page_route.constructor ? page_route.constructor.name : typeof page_route));
...
var CollectionTree = (function (_Tree2) {
  ...
  _createClass(CollectionTree, [{
    ...
    value: function handle_asset(asset_path, key) {
      if (typeof asset_path !== "string") throw new TypeError("Value of argument 'asset_path' violates contract, expected string got " + (asset_path === null ? "null" : asset_path instanceof Object && asset_path.constructor ? asset_path.constructor.name : typeof asset_path));
