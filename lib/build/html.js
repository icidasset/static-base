...
function retrieve(path_to_retrieve, base_path, callback) {
  if (typeof path_to_retrieve !== "string") throw new TypeError("Value of argument 'path_to_retrieve' violates contract, expected string got " + (path_to_retrieve === null ? "null" : path_to_retrieve instanceof Object && path_to_retrieve.constructor ? path_to_retrieve.constructor.name : typeof path_to_retrieve));
