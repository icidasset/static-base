...
function make_tree(static_base) {
  ...
  var parsers = {
    ...
    parse_markdown: function parse_markdown(contents) {
      return utils.parse_markdown(static_base.markdown_parser, contents, !!static_base.options.content.frontmatter.use_toml_syntax);
    }
  };
